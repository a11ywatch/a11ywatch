      ...
      <Box>
        ...
        <PaperSection rightMargin={false}>
          ...
          <Heading variant='h6' component='h4' bold={false}>
            ...
            trying our best to provide the best experience to our capabilities.
        ...
        <PaperSection row>
          ...
          <div>
            ...
            <Heading variant='h6' component='h4' bold={false}>
              ...
              provide a CDN to override the issues at runtime using javascript.
              We can manipulate the dom to apply the fixes as soon as the page
              loads. The manipulation of the dom in our context can be very
              minimal and fast since everything is synchronous. This means that
              content can adjust quick enough to prevent elements from shifting
              and flickering.
            </Heading>
          </div>
        </PaperSection>
        ...
        <PaperSection rightMargin={false} row>
          <div>
            ...
            <Heading variant='h6' component='h4' bold={false}>
              ...
              you should be able to live edit the script so that the changes can
              be applied on your custom CDN.
            </Heading>
          </div>
          <Image
        ...
        >
          ...
          <div>
            ...
            <Heading variant='h6' component='h4' bold={false}>
              ...
              since the speed of scripts varies greatly on the users device.
              This process would be hooked into your deployment or build steps
              so that way it can run seamless.
            </Heading>
          </div>
        </PaperSection>
        ...
        <PaperSection rightMargin={false} row>
          <div>
            ...
            <Heading variant='h6' component='h4' bold={false}>
              ...
              the remedies automatically to code. At this level we will support
              the most popular front-end frameworks first besides basic html
              support.
            </Heading>
          </div>
          <Image
