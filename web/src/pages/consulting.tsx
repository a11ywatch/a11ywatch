...
function Consulting() {
  ...
  return (
    <MarketingDrawer title={Consulting.name}>
      <Box>
        ...
        <Typography variant='body1' component='p' gutterBottom>
          ...
          without using any overlays, toolbars, and other manual processes that
          do not correct the issues without the user input. When we use our AI
          we make sure that the probability meets high standards or we make sure
          that the remedies are correct by a human. This allows us to deliver
